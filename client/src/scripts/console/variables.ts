...
export const defaultBinds = Object.freeze({
    ...
    "other_weapon": ["Space"],
    "swap_gun_slots": ["T"],
    "cycle_items -1": ["MWheelUp", "Button6"],
    "cycle_items 1": ["MWheelDown", "Button7"],
    "+attack": ["Mouse0", "Button5"],
    "drop": ["Button3"],   
    "reload": ["R", "Button2"],
    "explode_c4": ["Z"],
    "cycle_scopes -1": ["Button4"],
    "cycle_scopes 1": [],
    "use_consumable gauze": ["7", "Button12"],
    "use_consumable medikit": ["8", "Button13"],
    "use_consumable cola": ["9", "Button14"],
    "use_consumable tablets": ["0", "Button15"],
    "cancel_action": ["X", "Button1"],
    "+view_map": [],
    "toggle_map": ["M", "Button9"],
    "toggle_minimap": ["N"],
    "toggle_hud": [],
    "+emote_wheel": ["Mouse2"],
    "+map_ping_wheel": ["C"],
